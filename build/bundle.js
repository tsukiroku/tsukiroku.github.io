...
var app = (function () {
    ...
    /* src/title.svelte generated by Svelte v3.48.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p1 = element("p");
    			p1.textContent = "Student developers in South Korea.";
    			attr_dev(p0, "class", "title svelte-x6ejnx");
    			set_style(p0, "color", themeScheme.default);
    			add_location(p0, file$1, 5, 4, 125);
    			attr_dev(p1, "class", "description svelte-x6ejnx");
    			add_location(p1, file$1, 6, 4, 191);
    			attr_dev(div, "class", "container svelte-x6ejnx");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ theme: themeScheme, id });
    	return [id];
    }
    ...
    /* src/next.svelte generated by Svelte v3.48.0 */
    const file = "src/next.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text("Projects ->");
    			attr_dev(p, "class", "next svelte-14bbo38");
    			set_style(p, "color", themeScheme.nextText);
    			add_location(p, file, 3, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ theme: themeScheme });
    	return [];
    }
